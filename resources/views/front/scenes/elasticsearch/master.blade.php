...
<head>
    ...
    {{--<link type="text/css" rel="stylesheet" href="{{ asset('css/angular-photoswipe.css') }}">--}}
...
<body
        ...
        ng-init="auth=true;initWcag()"
        @else
        ng-init="auth=false;initWcag()"
        @endif
>

{{--<perfect-scrollbar class="scroller" wheel-propagation="true" wheel-speed="50" style="">--}}
...
<script type="text/javascript" src="{{ asset('js/angular-photoswipe-fragments.js') }}"></script>
