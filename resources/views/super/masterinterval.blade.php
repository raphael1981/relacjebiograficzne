...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('css/ng-tags-input.bootstrap.css') }}">
    <link type="text/css" rel="stylesheet" href="{{ asset('css/ng-tags-input.css') }}">
            ...
            <ul class="nav navbar-nav">
                ...
                <li role="presentation" class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <form action="http://www.czasooznaczacz.dsh.waw.pl" method="post" style="display:block-inline">
...
<section class="content">
    <div class="container-fluid loading-area">
        {!! $content !!}
    </div>
</section>
...
<script type="text/javascript" src="{{ asset('js/angular-linq.min.js') }}"></script>
