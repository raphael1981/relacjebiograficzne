                                        ...
                                        <table>
                                            <tr>
                                                <th>
                                                    ...
                                                    {{--<h4 class="text-center">Twoja rejestracja zostanie usunięta z systemy za 12h</h4>--}}
                                                    <h5>Aby rozpocząć proces pełnego dostępu kliknij link weryfikacyjny</h5>
                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        <td style="text-align: center">
                                                                            <center data-parsed="">
                                                                                <a href="{{ url('customer/reset/'.$customer->remember_token) }}" align="center" class="float-center">Kliknij aby zweryfikować</a>
                                                                            </center>
                                                                        </td>
                                                                    </tr>
                                                                </table>
