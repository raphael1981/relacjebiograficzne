...
ngPhotoSwipe.directive('photoSwipe', ['$http', '$location', function ($http, $location) {
	...
	var linkFn = function(scope, elem, attr) {
		...
		scope.searchimages = attr.searchImages;
...
ngPhotoSwipe.directive('photoSwipeSearch', ['$http', '$location', function ($http, $location) {
	var template =
			'<div class="photoswipe-gallery" itemscope itemtype="http://schema.org/ImageGallery">' +
			'<div photo-gallery-search images="images" class="{{ figureclass }}"></div>' +
			'</div>';
...
ngPhotoSwipe.directive('photoGallery', [ function () {
	var template =
			...
			'<a href="{{img._source.image_link_generate}}" itemprop="contentUrl" data-size="{{img._source.image_size}}">' +
			'<div class="curtain onegall"></div>'+
			'<img ng-src="{{img._source.image_link}}" itemprop="thumbnail" alt="{{img._source.description}}" class="img-responsive" />' +
			'</a>' +
			'<div class="tlo-gif"><img src="/images/loading.svg" alt="obrazek ładownia przed pełną odsłoną zdjęcia"></div>'+
			'</div>' +
			'</div>' +

			'<figcaption itemprop="caption description">{{img._source.description}}</figcaption>' +
			'</figure>';
...
ngPhotoSwipe.directive('photoGallerySearch', [ function () {
	var template =
			'<figure class="{{ fclass }} {{ img.orientation }}" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" ng-repeat="img in images">'+
			'<div class="image-content" ng-switch on="img.type">' +
				// '<div ng-switch-when="video">' +
				...
				// '</div>' +
			'<div ng-switch-default>' +
			'<a href="{{img.image_link_generate}}" itemprop="contentUrl" data-size="{{img.image_size}}">' +
			'<div class="curtain onegall"></div>'+
			...
			//'<figcaption itemprop="caption description">{{img.highlight.all}}</figcaption>' +
			'</figure>';
